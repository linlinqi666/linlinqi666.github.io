 ...
 * 预生成全站搜索索引，供 static/js/core/search.js 运行时读取。
 *
 * 用法：node tools/search-index-generator.js
 * 输出：static/js/core/search-index.js  （window.iGEMSearchIndex = [...]）
 *
 * 注意：本脚本为工程化构建工具（依赖 linkedom），不属于浏览器运行时资源，
 * 故放在 tools/ 而非 static/js/。ROOT 指向仓库根目录。
 */
const fs = require('fs');
