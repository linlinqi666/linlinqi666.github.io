/* 平面长条带轮播：卡片在可裁切视口内横向平移，取代旧的 3D 等轴测旋转木马。
 * 与根目录 static/js/components/hp-flat-carousel.js 保持同一套交互：
 * 左右箭头 / 键盘方向键 / 点击卡片，卡片与下方文章详情联动切换。
 * 图片走 iGEM 上传 CDN（static.igem.wiki）。Flask 站 static/ 目录仅允许 CSS/JS、
 * 不得存放图片；本地预览图片不显示属预期，上线后由 CDN 提供。
 */
(function () {
  'use strict';

  var articleDefinitions = [
    { id: 'section-overview', time: '', title: '项目概述', img: 'https://static.igem.wiki/2026/szpu-china/image/any-icon/home.webp', summary: '了解项目背景、目标，以及团队如何把人类实践反馈转化为工程设计。' },
    { id: 'section-carousel', time: '26/07/31', title: '清华参赛交流', img: 'https://static.igem.wiki/2026/szpu-china/image/HP/tsinghua/1.webp', summary: '与其他 iGEM 团队交流项目思路、实验经验和后续合作方向。' },
    { id: 'section-southchina', time: '26/08/01', title: '华南交流会', img: 'https://static.igem.wiki/2026/szpu-china/image/HP/southchina/SZU.jpg', summary: '围绕真实应用需求，收集来自高校与产业伙伴的反馈。' },
    { id: 'section-education', time: '26/08/03', title: '中学生科普', img: 'https://static.igem.wiki/2026/szpu-china/image/HP/school1.jpg', summary: '把合成生物学知识带进校园，让更多学生理解生物传感器的价值。' }
  ];
  ...
  function init() {
    ...
    articleDefinitions.forEach(function (definition) {
      ...
      if (!article.img) {
        console.warn('[HP carousel] 文章“' + article.title + '”缺少配图，已跳过。请设置 data-hp-image。');
        return;
      }
